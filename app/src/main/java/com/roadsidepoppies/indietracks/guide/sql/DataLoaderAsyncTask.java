package com.roadsidepoppies.indietracks.guide.sql;
...
public class DataLoaderAsyncTask extends AsyncTask<Boolean, String, Festival> {
    ...
    protected void onPreExecute() {
        ...
        if (!isCancelled()) {
            dialog = ProgressDialog.show(activity, "", "Loading indietracks data", true);
    ...
    protected void onPostExecute(Festival festival) {
        ...
        dialog.dismiss();
        Intent intent = new Intent("com.roadsidepoppies.indietracks.guide.INDIETRACKS");
