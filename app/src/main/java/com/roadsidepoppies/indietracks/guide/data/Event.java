package com.roadsidepoppies.indietracks.guide.data;

import com.roadsidepoppies.indietracks.guide.alarm.EventAlarmManager;
...
public class Event implements Comparable<Event>{
    ...
    public String getKey() {
        if (key == null) {
            key = String.format("%s|%s|%s|%s", EventAlarmManager.ALARMKEY_PREFIX, artist.name, location.name, dayFormat.format(start.getTime()));
        }
        return key;
    }
