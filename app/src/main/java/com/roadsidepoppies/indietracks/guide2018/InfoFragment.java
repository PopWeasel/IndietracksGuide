...
public class InfoFragment extends Fragment {
    ...
    public static final String FESTIVAL = "Extra Festival information";
    ...
    StringBuffer festival = new StringBuffer();
    {
        ...
        if (about.length() == 0) {
            ...
            about.append("<p />All copyrighted text, images and icons used with official permission of the Indietracks team (indietracksfestival@gmail.com).").append("\n");
        }
        if (festival.length() == 0) {
            festival.append("<h2>Train Stage</h2>").append("\n");
            festival.append("Please note, we now have a fairer queuing system for the train stage, and guests can only join at Swanwick Junction. If you are already on the train, please alight and join the queue at Swanwick Junction. Thank you!").append("\n");
            festival.append("<h2>Indietots Area</h2>").append("\n");
            festival.append("Located in Swanick Junction station building").append("\n");
            festival.append("<h2>Indiekids Area</h2>").append("\n");
            festival.append("<h3>at the top of the festival site, near to Johnson’s Buffet</h3>").append("\n");
            festival.append("<h4>All day drop-in craft session, Saturday and Sunday, Midday – 18:00</h4>").append("\n");
            festival.append("A new drop-in craft area at Indietracks for kids of all ages. All materials are provided free of charge, and there will be a range of activities including making a large collage, train-related crafts, and glitter and sparkle activities. The area will be run by Janet and Kelly, who have previously lead a crafting area at Bearded Theory festival, and we can’t wait to welcome them to Indietracks!").append("\n");
            festival.append("<h2>Carry Together Sling Library drop-in</h2>").append("\n");
            festival.append("<h3>Time: 12.30 – 14.30, Saturday and Sunday in the IndieTots area</h3>").append("\n");
            festival.append("Lots of people find carrying children is easier than using a buggy at festivals. Carry Together – a volunteer-run sling library that holds regular sessions across North Derbyshire – will be on-hand to help even more families enjoy babywearing at Indietracks this year. You can ask their Slingababy-trained carrying consultants anything you want about babywearing, try on some slings/carriers and even hire them for a small fee, which will help Carry Together continue their great work. And, of course, mean that you and your babes can enjoy the bands and workshops without struggling with your buggy in the (sometimes inevitable!) mud. Meet you down the front!").append("\n");
        ...
        infoTextMap.put(FESTIVAL, Html.fromHtml(festival.toString()));
    }
