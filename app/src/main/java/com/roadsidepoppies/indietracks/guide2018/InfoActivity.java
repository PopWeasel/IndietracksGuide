...
public class InfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (currentItemId < 0)
            displayInfoFragment(InfoFragment.FESTIVAL);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.info_about:
                ...
                return true;
            case R.id.info_festival:
                displayInfoFragment(InfoFragment.FESTIVAL);
                return true;
            case R.id.info_action:
                intent.setAction("com.roadsidepoppies.indietracks.guide2018.INDIETRACKS");
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(intent);
                return true;
            case R.id.settings_action:
                intent.setAction("com.roadsidepoppies.indietracks.guide2018.SETTINGS");
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(intent);
                return true;
